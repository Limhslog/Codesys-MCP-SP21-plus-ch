...
function renderLibraryMd(libs: LibrariesData, runtimeAnchorVersion?: string): string {
  ...
  L.push('');
  L.push('Auto-generated by `list_project_libraries` from the [`Limhslog/Codesys-MCP-SP21-plus-ch`](https://github.com/Limhslog/Codesys-MCP-SP21-plus-ch) fork (downstream of [`phobicdotno/Codesys-MCP-SP21-plus`](https://github.com/phobicdotno/Codesys-MCP-SP21-plus)).');
  L.push('');
  L.push('## Versions');
  L.push('');
  L.push('| Field | Value |');
...
function renderPouDumpMd(pou: PouEntry[], projectName: string): string {
  ...
  L.push('');
  L.push(`Generated ${today} from the live CODESYS instance via the [\`Limhslog/Codesys-MCP-SP21-plus-ch\`](https://github.com/Limhslog/Codesys-MCP-SP21-plus-ch) fork (downstream of [\`phobicdotno/Codesys-MCP-SP21-plus\`](https://github.com/phobicdotno/Codesys-MCP-SP21-plus)).`);
  L.push('');
